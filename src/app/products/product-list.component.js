...
var ProductListComponent = (function () {
    ...
    ProductListComponent.prototype.onSelect = function (hero) {
        this.router.navigate(['/product', hero.productId]);
    };
    ProductListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._productService.getProducts()
            .subscribe(function (products) { return _this.products = products; }, function (error) { return _this.errorMsg = error; });
    };
